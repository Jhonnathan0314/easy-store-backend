...
public class ChangeStateByIdProductUseCase {
    ...
    public Product changeStateById(Long id) throws NonExisteceException {
        Optional<Product> optProduct = productRepository.findById(id);
        if(optProduct.isEmpty()) throw new NonExisteceException(errorMessages.NON_EXISTENT_DATA);
