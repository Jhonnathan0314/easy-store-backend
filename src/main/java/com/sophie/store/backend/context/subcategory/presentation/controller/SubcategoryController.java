...
public class SubcategoryController {
    ...
    public ResponseEntity<ApiResponse<SubcategoryResponseDTO>> create(@RequestBody SubcategoryCreateDTO role, @PathVariable Long idCategory) {
        ApiResponse<SubcategoryResponseDTO> response = new ApiResponse<>();
        try {
    ...
    public ResponseEntity<ApiResponse<SubcategoryResponseDTO>> update(@RequestBody SubcategoryUpdateDTO role, @PathVariable Long idCategory) {
        ApiResponse<SubcategoryResponseDTO> response = new ApiResponse<>();
        try {
