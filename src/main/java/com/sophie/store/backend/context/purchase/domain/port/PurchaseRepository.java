package com.sophie.store.backend.context.purchase.domain.port;
...
public interface PurchaseRepository {
    ...
    List<Purchase> findByDate(Timestamp date);
    List<Purchase> findByDateBetween(Timestamp fromDate, Timestamp toDate);
